...
class SquareButton extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: ConstantsWidget.borderRadius_14),
  ...
  _returnedWidget(BuildContext context, ThemeData theme) {
    if (icon != null) {
      ...
      return centerDisable ?SvgPicture.asset(svgIcon!,color: color,): Center(
        child: SvgPicture.asset(svgIcon!,color: color,),
      );
